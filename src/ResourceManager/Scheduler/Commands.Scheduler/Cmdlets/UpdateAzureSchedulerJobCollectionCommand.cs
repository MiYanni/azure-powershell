...
namespace Microsoft.Azure.Commands.Scheduler.Cmdlets
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Set, "AzureRmSchedulerJobCollection", SupportsShouldProcess = true), OutputType(typeof(PSJobCollectionDefinition))]
    public class UpdateAzureSchedulerJobCollectionCommand : SchedulerBaseCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            ConfirmAction(
                string.Format(Resources.UpdateHttpJobResourceDescription, JobCollectionName),
                JobCollectionName,
                () =>
                {
                    WriteObject(SchedulerClient.UpdateJobCollection(updateJobCollectionParams));
                }
            ); 
        }
    }
