...
namespace Microsoft.Azure.Commands.Scheduler.Cmdlets
{
    ...
    public class NewAzureSchedulerServiceBusTopicJobCommand : JobBaseCmdlet, IDynamicParameters
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            ConfirmAction(
                string.Format(Resources.NewServiceBusTopicJobResourceDescription, JobName),
                JobCollectionName,
                () =>
                {
        ...
        public object GetDynamicParameters()
        {
            ...
            {
                runtimeDefinedParameterDictionary = AddErrorActionParameters(ErrorActionType, true);
            }
