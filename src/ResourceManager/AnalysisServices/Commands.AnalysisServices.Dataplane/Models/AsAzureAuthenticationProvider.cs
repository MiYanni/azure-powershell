...
#if NETSTANDARD
                        result = authenticationContext.AcquireTokenAsync(resourceUri, new IdentityModel.Clients.ActiveDirectory.ClientAssertionCertificate(asAzureContext.Account.Id, certificate)).Result;
#else
