...
namespace Microsoft.Azure.Commands.Sql.Database.Services
{
    ...
    public class ImportExportDatabaseCommunicator
    {
        ...
        /// </summary>
        public ImportExportResponse Export(string resourceGroupName, string serverName, string databaseName, ExportRequestParameters parameters)
        {
        ...
        /// </summary>
        public ImportExportResponse Import(string resourceGroupName, string serverName, ImportRequestParameters parameters)
        {
        ...
        /// </summary>
        public ImportExportOperationStatusResponse GetStatus(string operationStatusLink)
        {
