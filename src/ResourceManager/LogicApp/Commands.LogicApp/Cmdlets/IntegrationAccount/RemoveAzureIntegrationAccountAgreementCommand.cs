    ...
    public class RemoveAzureIntegrationAccountAgreementCommand : LogicAppBaseCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            ConfirmAction(Force.IsPresent,
                string.Format(CultureInfo.InvariantCulture, Properties.Resource.RemoveResourceWarning, "Microsoft.Logic/integrationAccounts/agreements", Name),
                string.Format(CultureInfo.InvariantCulture, Properties.Resource.RemoveResourceMessage, "Microsoft.Logic/integrationAccounts/agreements", Name),
                Name,
                () => {
                    IntegrationAccountClient.RemoveIntegrationAccountAgreement(ResourceGroupName, Name, AgreementName);
                });
        }
    }
}