...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    {
        protected object CreateVirtualMachineScaleSetVMPerformMaintenanceDynamicParameters()
        {
        ...
        protected void ExecuteVirtualMachineScaleSetVMPerformMaintenanceMethod(object[] invokeMethodInputParameters)
        {
    ...
    {
        protected PSArgument[] CreateVirtualMachineScaleSetVMPerformMaintenanceParameters()
        {
