...
namespace Microsoft.Azure.Commands.Compute
{
    ...
    public class RemoveAzureVMAccessExtensionCommand : VirtualMachineExtensionBaseCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            ExecuteClientAction(() =>
            {
                if (ShouldProcess(VMName, Properties.Resources.RemoveAccessExtensionAction)
                    && (Force.IsPresent
                ...
                {
                    var op = VirtualMachineExtensionClient.DeleteWithHttpMessagesAsync(ResourceGroupName,
                        VMName,
