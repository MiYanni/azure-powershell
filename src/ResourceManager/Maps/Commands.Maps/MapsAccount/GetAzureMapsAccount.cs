        ...
        public override void ExecuteCmdlet()
        {
            ...
            RunCmdLet(() =>
            {
                switch (ParameterSetName)
                {
                    ...
                    {
                        var mapsAccount = MapsClient.Accounts.Get(ResourceGroupName, Name);
                    ...
                    case ResourceGroupParameterSet:
                    {
                        ...
                        {
                            var mapsAccounts = MapsClient.Accounts.ListBySubscription();
                            WriteMapsAccountList(mapsAccounts);
                        }
                        else
                        {
                            var mapsAccounts = MapsClient.Accounts.ListByResourceGroup(ResourceGroupName);
                            WriteMapsAccountList(mapsAccounts);
                        }
                        break;
                    }
                    case ResourceIdParameterSet:
                    {
                        ...
                        {
                            var mapsAccount = MapsClient.Accounts.Get(resourceGroupName, resourceName);
                            WriteMapsAccount(mapsAccount);
                        }
                        break;
                    }
