...
namespace Microsoft.Azure.Commands.Insights.Test
{
    public class CustomPrinterTests
   {
        ...
        public void CustomPrinterTest_ComplexTypes()
        {
            ...
            var eventData = Utilities.CreateFakeEvent(null, false);
            ...
            // Must be "{\r\n[k1, v1]\r\n[k2, v2]\r\n}" in the future
            Assert.Equal(
                $"     : [k1, v1]{Environment.NewLine}     : [k2, v2]{Environment.NewLine}",
                result);

            dictionarySO.Add("k1", eventData);
            dictionarySO.Add("k2", Utilities.CreateFakeEvent("secondId", false));
            ...
            Assert.Equal(
                $"     : [k1, Microsoft.Azure.Management.Monitor.Models.EventData]{Environment.NewLine}     : [k2, Microsoft.Azure.Management.Monitor.Models.EventData]{Environment.NewLine}",
                result);
        }
    }
}
