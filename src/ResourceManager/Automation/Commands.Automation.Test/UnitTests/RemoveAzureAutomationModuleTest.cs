...
namespace Microsoft.Azure.Commands.ResourceManager.Automation.Test.UnitTests
{
    ...
    public class RemoveAzureAutomationModuleTest : RMTestBase
    {
        ...
        public void SetupTest()
        {
            ...
            cmdlet = new RemoveAzureAutomationModule
            {
        ...
        public void RemoveAzureAutomationModuleByNameSuccessfull()
        {
            ...
            mockAutomationClient.Setup(f => f.DeleteModule(resourceGroupName, accountName, moduleName));

            // Test
            cmdlet.ResourceGroupName = resourceGroupName;
            cmdlet.AutomationAccountName = accountName;
            cmdlet.Name = moduleName;
            cmdlet.Force = true;
            cmdlet.ExecuteCmdlet();

            // Assert
            mockAutomationClient.Verify(f => f.DeleteModule(resourceGroupName, accountName, moduleName), Times.Once());
        }
    }
}
