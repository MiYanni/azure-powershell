...
namespace Microsoft.Azure.Commands.ResourceManager.Automation.Test.UnitTests
{
    ...
    public class SuspendAzureAutomationJobTest : RMTestBase
    {
        ...
        public void SetupTest()
        {
            ...
            cmdlet = new SuspendAzureAutomationJob
            {
        ...
        public void SuspendAzureAutomationJobSuccessfull()
        {
            ...
            mockAutomationClient.Setup(f => f.SuspendJob(resourceGroupName, accountName, jobId));
            ...
            // Assert
            mockAutomationClient.Verify(f => f.SuspendJob(resourceGroupName, accountName, jobId), Times.Once());
        }
    }
}
