...
namespace Microsoft.Azure.Commands.ResourceManager.Automation.Test.UnitTests
{
    ...
    public class GetAzureAutomationWebhookTest : RMTestBase
    {
        ...
        public void SetupTest()
        {
            ...
            cmdlet = new GetAzureAutomationWebhook
            {
        ...
        public void GetAzureAutomationWebhookByNameSuccessful()
        {
            ...
            mockAutomationClient.Setup(f => f.GetWebhook(resourceGroupName, accountName, webhookName));
            ...
            // Assert
            mockAutomationClient.Verify(f => f.GetWebhook(resourceGroupName, accountName, webhookName), Times.Once());
        }
    }
}