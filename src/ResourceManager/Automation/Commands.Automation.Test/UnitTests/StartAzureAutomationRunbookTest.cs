...
namespace Microsoft.Azure.Commands.ResourceManager.Automation.Test.UnitTests
{
    ...
    public class StartAzureAutomationRunbookTest : RMTestBase
    {
        ...
        public void SetupTest()
        {
            ...
            cmdlet = new StartAzureAutomationRunbook
            {
        ...
        public void StartAzureAutomationRunbookByNameSuccessfull()
        {
            ...
            mockAutomationClient.Setup(f => f.StartRunbook(resourceGroupName, accountName, runbookName, null, null));
            ...
            // Assert
            mockAutomationClient.Verify(f => f.StartRunbook(resourceGroupName, accountName, runbookName, null, null), Times.Once());
        }
    }
}
