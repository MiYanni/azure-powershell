...
namespace Microsoft.Azure.Commands.Network
{
    ...
    public class AddAzureNetworkInterfaceIpConfigCommand : AzureNetworkInterfaceIpConfigBase
    {
        ...
        {     
            ...
            var existingIpConfig = NetworkInterface.IpConfigurations.SingleOrDefault(resource => string.Equals(resource.Name, Name, StringComparison.CurrentCultureIgnoreCase));
            ...
            NetworkInterface.IpConfigurations.Add(ipconfig);
